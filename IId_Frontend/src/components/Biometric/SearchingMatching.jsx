...
const SearchingMatching = () => {
    return (
        <div className="container">
            <div className="text-White-100 text-4xl text-center ml-[13%] p-5 font-bold">Biometric Matching Interface</div>
            <div className="flex w-full max-w-screen-xl border-2 mt-[10%] shifted items-center ml-[12%] rounded-[20px]" >
                ...
                <div className="w-2/4 h-[250px] rounded-[20px] bg-White-100 p-5  m-4 flex flex-col items-center justify-center space-y-10">
                    <p className="text-xl md:text-4xl font-bold text-darkBlue-500" > Upload Photo to match</p>
                    <div >
                        <input type="file" />
                ...
                {/* Middle column */}
                <div className="w-2/4 h-[250px] rounded-[20px] bg-White-100 p-5  m-4 flex flex-col items-center justify-center space-y-10">
                    <p className="text-xl md:text-4xl font-bold text-darkBlue-500" > Upload Signature to match</p>
                    <div >
                        <input type="file" />
                ...
                {/* Center column */}
                <div className="w-2/4 h-[250px] rounded-[20px] bg-White-100 p-5  m-4 flex flex-col items-center justify-center space-y-10">
                    <p className="text-xl md:text-4xl font-bold text-darkBlue-500" > Upload Fingerprint to match</p>
                    <div >
                        <input type="file" />
...
export default SearchingMatching;
